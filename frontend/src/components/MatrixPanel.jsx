...
//     // const scenarios = testCases.testCase;
//     // const row = testCases;

//     //ID Generation (Mock)
//     const reqId = "REQ-" + Math.floor(Math.random() * 1000);
//     const tcIdPrefix = "TC-" + Math.floor(Math.random() * 1000);
//     // const reqId = testCases.requirementId;
//     // const tcIdPrefix = testCases.testCaseId;
...
const MatrixPanel = ({ testCases }) => {

    // testCases is now a LIST/ARRAY
    // Example:
    // [
    //   {
    //     testCaseId: "TC-001",
                        ...
                        <tbody className="divide-y divide-slate-700/50">
                            ...
                            {testCases.map((row, index) => (
                                ...
                                >
                                    ...
                                    <td className="p-4">
                                        <span
                                            className={`px-2 py-1 rounded text-xs font-bold ${getPriorityStyle(row.priority)}`}
                                        >
                                            {row.priority}
                                        </span>
                                    </td>
